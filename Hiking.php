...
<head>
    ...
    <style>
        ...
        .image-section {
            flex: 1;
            background: url('hik.jpg') center center/cover no-repeat;
            height: auto;
            min-height: 400px;
        }
    </style>
...
if(isset($_POST['save'])){
    ...
    $h=$_POST['budget'];
    $i=$_POST['currency'];
	mysqli_query($conn,"insert into hiking(id,fname,lname,email,phone,date,age,children,budget,currency) values(null,'$a','$b','$c','$d','$e','$f','$g','$h','$i')");
}
?>